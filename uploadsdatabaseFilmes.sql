...
INSERT IGNORE INTO filme (nome, dataLancamento, classificacao, orcamento)
                  VALUES ('Filme1', '1999-03-04', 0, 984.77),
                         ('Filme2', '1998-03-04', 12, 754.00),
                         ('Filme3', '1999-05-04', 18, 6675.50),
                         ('Filme4', '2008-06-04', 18, 66467);
